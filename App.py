        ...
        with open(CAMINHO_CSV, 'w', newline='') as csvfile:
           ...
           for page in reader.pages:                
              ...
              if (page.extract_text().find('DOCUMENTO PARA PAGAMENTO DA CONTA COLETIVA') == -1 and controlarPag == 0 and
                 ...
                 CSV_FOLDER_ID = "https://drive.google.com/drive/folders/1yUMrkdAVCyDOKTZBgCJswX9-5RyzMXJk?usp=drive_link"
                 EXCEL_FOLDER_ID = "https://drive.google.com/drive/folders/1DHhyClzxO_pk6UXD7bf6sROkJ695e0bd?usp=drive_link"
